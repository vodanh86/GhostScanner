...
; Schema: 0
                                      ...
                                      %1 = OpExtInstImport "GLSL.std.450" 
                                             OpMemoryModel Logical GLSL450 
                                             OpEntryPoint Fragment %4 "main" %22 %37 %52 
...
UniformConstant read_only Texture2D* %39 = OpVariable UniformConstant 
            UniformConstant sampler* %41 = OpVariable UniformConstant 
                         ...
                         Output f32* %52 = OpVariable Output 
                                 void %4 = OpFunction None %3 
                                      %5 = OpLabel 
          ...
          read_only Texture2DSampled %43 = OpSampledImage %40 %42 
                               ...
                               f32_4 %45 = OpImageSampleImplicitLod %43 %44 
                                 f32 %48 = OpCompositeExtract %45 0 
                        Private f32* %50 = OpAccessChain %25 %47 
                                             OpStore %50 %48 
                        Private f32* %53 = OpAccessChain %25 %47 
                                 f32 %54 = OpLoad %53 
                                             OpStore %52 %54 
                                             OpReturn
                                             OpFunctionEnd
