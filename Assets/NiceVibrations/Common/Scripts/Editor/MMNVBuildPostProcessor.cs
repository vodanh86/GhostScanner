    ...
    public class MMNVBuildPostProcessor : IPostprocessBuildWithReport
    {
        ...
        public static void ConfigureXCodeProjectForNativePlugin(string xcodeProjectPath)
        {
            ...
            pbxProject.ReadFromString(File.ReadAllText(pbxProjectPath));
                ...
                WritePropertiesToFramework(pbxProject, targetGUID, pbxProjectPath, pluginPath);
            #else
                string unityTargetName = PBXProject.GetUnityTargetName();
                string targetGUID = pbxProject.TargetGuidByName(unityTargetName);
                WritePropertiesToProject(pbxProject, targetGUID, pbxProjectPath, pluginPath);
            #endif
        ...
        private static void WritePropertiesToProject(PBXProject pbxProject, string targetGUID, string pbxProjectPath, string pluginPath)
        {
        ...
        /// <param name="pbxProjectPath"></param>
        /// <param name="pluginPath"></param>
        private static void WritePropertiesToFramework(PBXProject pbxProject, string targetGUID, string pbxProjectPath, string pluginPath)
        {
