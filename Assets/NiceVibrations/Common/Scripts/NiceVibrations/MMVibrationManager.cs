...
namespace MoreMountains.NiceVibrations
{
	...
	{        
		...
		public static void Haptic(HapticTypes type, bool defaultToRegularVibrate = false, bool alsoRumble = false, MonoBehaviour coroutineSupport = null)
		{
            if (!_vibrationsActive)
            {
                return;
            ...
            if (alsoRumble && (coroutineSupport != null))
            {
                ...
                switch (type)
                {
                    ...
                    case HapticTypes.RigidImpact:
                        ...
                        break;
                    case HapticTypes.SoftImpact:
                        MMNVRumble.Rumble(_rumbleSoft.x, _rumbleSoft.y, _rumbleSoft.z, coroutineSupport);
                        break;
                }
                #endif
            }
        ...
        public static void TransientHaptic(float intensity, float sharpness, bool alsoRumble = false, MonoBehaviour coroutineSupport = null)
        {
            if (!_vibrationsActive)
            {
                return;
            ...
            {
                #if MOREMOUNTAINS_NICEVIBRATIONS_RUMBLE
                    MMNVRumble.Rumble(intensity, sharpness, 0.08f, coroutineSupport);
                #endif
            }
        }
        ...
        public static void ContinuousHaptic(float intensity, float sharpness, float duration, HapticTypes fallbackOldiOS = HapticTypes.None, MonoBehaviour mono = null, bool alsoRumble = false)
        {
            if (!_vibrationsActive)
            {
                return;
                                                ...
                                                MonoBehaviour coroutineSupport = null)
        {
            ...
            {
                MMNVRumble.Rumble(rumblePattern, rumbleLowFreqAmplitudes, rumbleHighFreqAmplitudes, rumbleRepeat, coroutineSupport);
            }                
            #endif            
        }
